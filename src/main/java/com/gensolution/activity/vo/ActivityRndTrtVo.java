...
public class ActivityRndTrtVo {
	private String drt_innb;
	private String drtp_innb;
	...
	public String getDrt_innb() {
		return drt_innb;
	}
	public void setDrt_innb(String drt_innb) {
		this.drt_innb = drt_innb;
	}
	public String getDrtp_innb() {
		return drtp_innb;
	}
	public void setDrtp_innb(String drtp_innb) {
		this.drtp_innb = drtp_innb;
	}
