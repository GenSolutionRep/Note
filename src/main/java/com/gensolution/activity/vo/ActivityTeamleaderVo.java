...
public class ActivityTeamleaderVo {
	
	private String yyyyMm;
	private String pre_yyyyMm;
	...
	private String pre_yy;
	private String pre_mm;
	private String yy;
	private String mm;
	...
	public String getPre_yyyyMm() {
		return pre_yyyyMm;
	}

	public void setPre_yyyyMm(String pre_yyyyMm) {
		this.pre_yyyyMm = pre_yyyyMm;
	}
	...
	public String getPre_yy() {
		return pre_yy;
	}

	public void setPre_yy(String pre_yy) {
		this.pre_yy = pre_yy;
	}

	public String getPre_mm() {
		return pre_mm;
	}

	public void setPre_mm(String pre_mm) {
		this.pre_mm = pre_mm;
	}
