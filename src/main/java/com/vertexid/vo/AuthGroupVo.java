...
public class AuthGroupVo {
	...
	private String ma_group_memo;
	private String ma_is_del;    
	...
	public String getMa_group_memo() {
		return ma_group_memo;
	}
	public void setMa_group_memo(String ma_group_memo) {
		this.ma_group_memo = ma_group_memo;
	}
	public String getMa_is_del() {
		return ma_is_del;
	}
	public void setMa_is_del(String ma_is_del) {
		this.ma_is_del = ma_is_del;
	}
